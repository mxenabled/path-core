...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:4.2.0")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:4.2.0"
  implementation "com.mx.path-core:context:4.2.0"
  implementation "com.mx.path-core:gateway:4.2.0"
  implementation "com.mx.path-core:http:4.2.0"
  implementation "com.mx.path-core:messaging:4.2.0"
  implementation "com.mx.path-core:utilities:4.2.0"

  annotationProcessor "com.mx.path-core:gateway-generator:4.2.0"

  testImplementation "com.mx.path-core:testing:4.2.0"
}
```
<!-- x-release-please-end -->
