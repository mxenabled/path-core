...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:1.5.0")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:1.5.0"
  implementation "com.mx.path-core:context:1.5.0"
  implementation "com.mx.path-core:gateway:1.5.0"
  implementation "com.mx.path-core:http:1.5.0"
  implementation "com.mx.path-core:messaging:1.5.0"
  implementation "com.mx.path-core:utilities:1.5.0"

  annotationProcessor "com.mx.path-core:gateway-generator:1.5.0"

  testImplementation "com.mx.path-core:testing:1.5.0"
}
```
<!-- x-release-please-end -->
