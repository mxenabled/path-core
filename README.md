...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:3.7.0")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:3.7.0"
  implementation "com.mx.path-core:context:3.7.0"
  implementation "com.mx.path-core:gateway:3.7.0"
  implementation "com.mx.path-core:http:3.7.0"
  implementation "com.mx.path-core:messaging:3.7.0"
  implementation "com.mx.path-core:utilities:3.7.0"

  annotationProcessor "com.mx.path-core:gateway-generator:3.7.0"

  testImplementation "com.mx.path-core:testing:3.7.0"
}
```
<!-- x-release-please-end -->
