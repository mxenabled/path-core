...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:3.6.0")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:3.6.0"
  implementation "com.mx.path-core:context:3.6.0"
  implementation "com.mx.path-core:gateway:3.6.0"
  implementation "com.mx.path-core:http:3.6.0"
  implementation "com.mx.path-core:messaging:3.6.0"
  implementation "com.mx.path-core:utilities:3.6.0"

  annotationProcessor "com.mx.path-core:gateway-generator:3.6.0"

  testImplementation "com.mx.path-core:testing:3.6.0"
}
```
<!-- x-release-please-end -->
