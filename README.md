...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:3.10.1")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:3.10.1"
  implementation "com.mx.path-core:context:3.10.1"
  implementation "com.mx.path-core:gateway:3.10.1"
  implementation "com.mx.path-core:http:3.10.1"
  implementation "com.mx.path-core:messaging:3.10.1"
  implementation "com.mx.path-core:utilities:3.10.1"

  annotationProcessor "com.mx.path-core:gateway-generator:3.10.1"

  testImplementation "com.mx.path-core:testing:3.10.1"
}
```
<!-- x-release-please-end -->
