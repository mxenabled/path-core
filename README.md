...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:4.1.0")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:4.1.0"
  implementation "com.mx.path-core:context:4.1.0"
  implementation "com.mx.path-core:gateway:4.1.0"
  implementation "com.mx.path-core:http:4.1.0"
  implementation "com.mx.path-core:messaging:4.1.0"
  implementation "com.mx.path-core:utilities:4.1.0"

  annotationProcessor "com.mx.path-core:gateway-generator:4.1.0"

  testImplementation "com.mx.path-core:testing:4.1.0"
}
```
<!-- x-release-please-end -->
