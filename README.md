...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:1.7.1")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:1.7.1"
  implementation "com.mx.path-core:context:1.7.1"
  implementation "com.mx.path-core:gateway:1.7.1"
  implementation "com.mx.path-core:http:1.7.1"
  implementation "com.mx.path-core:messaging:1.7.1"
  implementation "com.mx.path-core:utilities:1.7.1"

  annotationProcessor "com.mx.path-core:gateway-generator:1.7.1"

  testImplementation "com.mx.path-core:testing:1.7.1"
}
```
<!-- x-release-please-end -->
