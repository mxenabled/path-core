...
```groovy
dependencies {
  api platform("com.mx.path-core:platform:1.6.1")
...
```groovy
dependencies {
  implementation "com.mx.path-core:common:1.6.1"
  implementation "com.mx.path-core:context:1.6.1"
  implementation "com.mx.path-core:gateway:1.6.1"
  implementation "com.mx.path-core:http:1.6.1"
  implementation "com.mx.path-core:messaging:1.6.1"
  implementation "com.mx.path-core:utilities:1.6.1"

  annotationProcessor "com.mx.path-core:gateway-generator:1.6.1"

  testImplementation "com.mx.path-core:testing:1.6.1"
}
```
<!-- x-release-please-end -->
