...
```groovy
dependencies {
  implementation 'com.github.mxenabled.path-sdk:common:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:context:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:gateway:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:gateway-generator:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:http:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:messaging:1.0.2'
  implementation 'com.github.mxenabled.path-sdk:utilities:1.0.2'

  testImplementation 'com.github.mxenabled.path-sdk:testing:1.0.2'
}
```
