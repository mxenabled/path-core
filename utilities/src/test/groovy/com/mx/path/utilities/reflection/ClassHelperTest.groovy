...
class ClassHelperTest extends Specification {
  ...
  def "getClass"() {
    ...
    when: "valid class"
    def created = subject.getClass("com.mx.path.utilities.reflection.TestClass")
  ...
  def "invokeMethod with resultType"() {
    ...
    then:
    e = thrown(RuntimeException)
    e.message == "No method secretMethod on class com.mx.path.utilities.reflection.TestClass"
    ...
    then:
    e = thrown(RuntimeException)
    e.message == "No method secretAndSafeMethod on class com.mx.path.utilities.reflection.TestClass"
