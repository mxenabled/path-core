...
class ObjectMapYamlDeserializerTest extends Specification {
  ObjectMapYamlDeserializer subject

  def setup() {
    subject = new ObjectMapYamlDeserializer()
  }
  ...
  def "1.1 max aliases"() {
    ...
    subject = new ObjectMapYamlDeserializer(ObjectMapYamlDeserializer.Parameters.builder().maxYamlAliases(2).build())
    ...
    subject = new ObjectMapYamlDeserializer(ObjectMapYamlDeserializer.Parameters.builder().maxYamlAliases(10).build())
    subject.fromYaml(yaml)
