...
public class ThrowableTypeAdapter extends TypeAdapter<Throwable> {
  private final Class<? extends Throwable> fallbackType;

  public ThrowableTypeAdapter() {
    this.fallbackType = RuntimeException.class;
  }

  public ThrowableTypeAdapter(Class<? extends Throwable> fallbackType) {
